package eu.activage.services;

import eu.activage.services.config.ApplicationProperties;
import eu.activage.services.config.DefaultProfileUtil;
...
public class SimlifeApp {

    private static final Logger log = LoggerFactory.getLogger(SimlifeApp.class);

    private final Environment env;

    public SimlifeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SimlifeApp.class);
