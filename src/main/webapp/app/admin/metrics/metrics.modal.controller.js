(function() {
    ...
    angular
        .module('simlifeApp')
        .controller('SimMetricsMonitoringModalController', SimMetricsMonitoringModalController);

    SimMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function SimMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
