package eu.activage.services.repository;

import eu.activage.services.SimlifeApp;
import eu.activage.services.config.Constants;
import eu.activage.services.config.audit.AuditEventConverter;
import eu.activage.services.domain.PersistentAuditEvent;
...
import static eu.activage.services.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
