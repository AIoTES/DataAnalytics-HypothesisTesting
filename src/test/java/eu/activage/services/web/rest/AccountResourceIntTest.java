...
import eu.activage.services.config.Constants;
...
import eu.activage.services.repository.AuthorityRepository;
...
import eu.activage.services.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@simlife.com");
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.email").value("john.doe@simlife.com"))
